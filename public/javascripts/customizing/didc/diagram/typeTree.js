const TypeTree = function(_id, _options) {
    ...
    const m_tree_data = [
        ...
        { id: '8', pid: null, name: '공조', icon: getTreeIconName('power_system', 0), open: true, is_use: 'N', iconSkin: 'icon-nouse', type: 'parent' },
        { id: '8-1', pid: '8', name: '한국전력: d-kepco', icon: getTreeIconName('power_system', 0), open: true, type: 'd-kepco' }
    ]
