const EquipmentTree = function(_id, _options) {
    ...
    /***************************************************************************************************************************************/
    /* by shkoh 20211231: create tree view start                                                                                           */
    /***************************************************************************************************************************************/
    ...
    // function appendSensor(equip_ids)
    /***************************************************************************************************************************************/
    /* by shkoh 20211231: create tree view end                                                                                             */
    /***************************************************************************************************************************************/

    /***************************************************************************************************************************************/
    /* by shkoh 20220103: data exchange start                                                                                              */
    /***************************************************************************************************************************************/
        ...
        return new Promise(function(resolve, reject) {
            $.ajax({
                ...
                data.forEach(function(datum) {    
                    ...
                    const p_node = m_group_tree.getNodeByParam('id', pid);
                    m_group_tree.addNodes(p_node, {
                        id: id,
                        pid: pid,
                        name: name,
                        open: true,
    ...
    /***************************************************************************************************************************************/
    /* by shkoh 20220103: data exchange end                                                                                                */
    /***************************************************************************************************************************************/
    ...
    function selectNode(id) {
        ...
        // by shkoh 20220103: 센서를 선택했을 경우에는 센서의 부모 id(equip_id)를 먼저 찾은 후에, 그 equip_id를 가지고 있는 센서 리스트를 불러온 후에, 특정 센서를 선택한다
        if(type === 'S') {
            getSensor(id.substring(2)).then(function(equip_id) {
                const p_node = m_group_tree.getNodeByParam('id', 'E_' + equip_id, null);
    ...
    function getSelectNode() {
        return m_group_tree.getSelectedNodes()[0];
    }
    /***************************************************************************************************************************************/
    ...
    return {
        CreateTree: function(id) { createTree(id); },
        SelectNode: function(id) { selectNode(id); },
