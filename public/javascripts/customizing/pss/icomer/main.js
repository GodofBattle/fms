...
$(function() {
    ...
    // by shkoh 20220720: 첫번째 페이지를 우선 선택함
    checkEquipSettings($('#tab-panel').data('kendoTabStrip').contentElements[0]);
});

/***********************************************************************************************************************/
/* by shkoh 20220720: resize window start                                                                              */
/***********************************************************************************************************************/
...
/***********************************************************************************************************************/
/* by shkoh 20220720: resize window end                                                                                */
/***********************************************************************************************************************/

/***********************************************************************************************************************/
/* by shkoh 20220720: initialize UI & elements start                                                                   */
/***********************************************************************************************************************/
...
/***********************************************************************************************************************/
/* by shkoh 20220720: initialize UI & elements end                                                                     */
/***********************************************************************************************************************/

/***********************************************************************************************************************/
/* by shkoh 20220720: data exchange start                                                                              */
/***********************************************************************************************************************/
...
function importItems() {
    $.ajax({
        ...
        dataType: 'json',
        cache: false,
        url: '/api/pss/icomer/mapper?pagename=' + g_icomer_mapping_data.page_name + '&objectname=' + g_icomer_mapping_data.object_name
    }).done(function(data) {
...
function checkEquipSettings(ele) {
    $.ajax({
        ...
        dataType: 'json',
        cache: false,
        url: '/api/pss/icomer/mapper?pagename=' + g_icomer_mapping_data.page_name
    }).done(function(data) {
...
/***********************************************************************************************************************/
/* by shkoh 20220720: data exchange end                                                                                */
/***********************************************************************************************************************/